...
function timer (date, id, alt) {
  ...
  var x = setInterval(function() {
    ...
    var colors = ["#3AD5C4", "#ECFD36", "#70FD56", "#FD45A5", "#AB53C4", "#0A4BB8"];
    ...
    if (seconds < 0) {
      ...
      document.getElementById(id).innerHTML = displayTime(days) + "  " + displayTime(hours) + ":"
...
var ids = {
  ...
  r1c3:{id:"r1c3",dt:"May 18, 2021 22:00:00", text:"CRUEL SUMMER EP 5 AIRS"}, 
  r1c4:{id:"r1c4",dt:"July 5, 2021 9:15:32", text:"BACK TO SCHOOL SALES BEGIN"}, 
  r1c5:{id:"r1c5",dt:"Sept 23, 2021 00:00:00", text:"LIBRA SZN"}, 
  r2c1:{id:"r2c1",dt:"Dec 12, 2021 03:02:28", text:"TOTAL SOLAR ECLIPSE"}, 
  r2c2:{id:"r2c2",dt:"July 23, 2021 07:00:00", text:"TOKYO OLYMPICS"}, 
  r2c3:{id:"r2c3",dt:"Sept 3, 2022 15:37:12", text:"SOLAR ORBITER'S 3RD VENUS FLYBY"},
  r2c4:{id:"r2c4",dt:"May 13, 2022 23:22:25", text:"ROBERT PATTINSON'S BIRTHDAY"}, 
  ...
  r5c5:{id:"r5c5",dt:"June 7, 2021 20:00:00", text:"BACHELORETTE SZN 17 AIRS"}, 
